...
export default function CheckoutPage() {
  ...
  try {
    // 1️⃣ Create Razorpay order (Backend API)
    const res = await fetch("/api/payments", {
      method: "POST",
      body: JSON.stringify({
        amount: product.price * qty,
        receipt: `order_${productId}`,
        product_id: product.id,   // Ensure this is passed
        quantity: qty,
      ...
      headers: {
        'Content-Type': 'application/json', // Ensure the request is correctly formatted
      },
    });
    ...
    if (!res.ok) {
      ...
      console.error("Payment API Error:", errorResponse.error);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="bg-white shadow-lg rounded-xl p-6">
          ...
          <button
            ...
            className="bg-green-600 hover:bg-green-700 text-white w-full py-3 rounded-lg text-lg mt-6"
          >
