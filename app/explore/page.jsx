...
function StageSection({ stage, reverse }) {
  return (
    <section className="py-12 md:py-20 border-b border-gray-200">
      <div
        className={`max-w-6xl mx-auto px-4 md:px-6 flex flex-col md:flex-row ${
      ...
      >
        ...
        <div className="md:w-1/2 text-gray-900 text-center md:text-left">
          ...
          <p className="text-base md:text-lg text-gray-700 mt-3 md:mt-4 leading-relaxed">
...
export default function ExplorePage() {
  return (
    <main className="bg-white min-h-screen">
      {/* TOP IMAGE */}
      <section className="py-16 md:py-24 text-center border-b border-gray-200">
        <img
          src="/images/stages/stages-circle.png"
          alt="Program Stages"
          className="mx-auto max-w-xs sm:max-w-md md:max-w-4xl"
        />
      </section>
